...
export const { useGetAgentDataQuery, useGetAgentByIdQuery, useCreateAgentMutation, useUpdateAgentMutation, useUpdateAgentStatusMutation, useUpdatePhonenoStatusMutation, useDeleteAgentMutation } = agentApi;
