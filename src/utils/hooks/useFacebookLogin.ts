...
export const useFacebookLogin = (onFinish?: (data: any) => void) => {
  ...
  const startLogin = useCallback(() => {
    ...
    window.FB.login(
      ...
      {
        scope: "public_profile,business_management,catalog_management,ads_management,ads_read,leads_retrieval,pages_manage_ads,pages_manage_metadata,pages_read_engagement,pages_show_list,whatsapp_business_management,whatsapp_business_messaging",
        return_scopes: true,
      }
    );
